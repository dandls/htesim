...
Files are encapsulated as following: Makefile -> run_study.R --> libs.R --> DGP.R --> def.R --> run.R
	...
	* DGP.R: Code to generate study data. 
	...
	* run.R: Code to define a base model, to fit a forest, to get estimates and to return the MSE. Also includes the definition of batchtools problems. 
